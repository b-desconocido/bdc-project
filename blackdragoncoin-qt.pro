TEMPLATE = app
TARGET = blackdragoncoin-qt
macx:TARGET = "BlackDragonCoin-Qt"
VERSION = 0.1.0.0
INCLUDEPATH += src src/json src/qt src/sj src/sj/code
QT += core gui network
greaterThan(QT_MAJOR_VERSION, 4): QT += widgets
DEFINES += QT_GUI BOOST_THREAD_USE_LIB BOOST_SPIRIT_THREADSAFE SCRYPT_CHACHA SCRYPT_KECCAK512 SCRYPT_CHOOSE_COMPILETIME
...
QT += testlib
TARGET = blackdragoncoin-qt_test
