...
unsigned char GetNFactor()
{
	return GetNFactor((pindexBest != NULL) ? pindexBest->nTime : ((pindexGenesisBlock != NULL) ? pindexGenesisBlock->nTime : 0));
}
...
Value gettxout(const Array& params, bool fHelp)
{
	...
	ret.push_back(Pair("rollbase", coins.fRollBase));
