    ...
    QSplashScreen(pixmap, f)
{
	...
	int paddingLeftCol2         = 16;
    int paddingTopCol2          = 29;
    int line1 = 0;
    int line2 = 13;
    int line3 = 26;
	int line4 = 39;
	...
	QString copyrightText3   = QChar(0xA9)+QString(" 2014 ") + QString(tr("The Black Dragon Coin developers"));
    ...
    pixPaint.setPen(QColor(160,170,220));
	...
	pixPaint.drawRect(0, 0, newPixmap.width()-1, newPixmap.height()-1);
