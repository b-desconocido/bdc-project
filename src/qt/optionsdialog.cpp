    ...
    fProxyIpValid(true)
{
	...
	ui->logo->addItem("primary", 0);
	ui->logo->addItem("alternative", 1);
	ui->logo->setCurrentIndex(0);
...
void OptionsDialog::setMapper()
{
	...
	mapper->addMapping(ui->logo, OptionsModel::LogoId);
...
void OptionsDialog::showRestartWarning_Proxy()
{
    ...
    {
        QMessageBox::warning(this, tr("Warning"), tr("This setting will take effect after restarting Black Dragon Coin."), QMessageBox::Ok);
